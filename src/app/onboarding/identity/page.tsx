...
const EXAMPLE_IDENTITIES = [
  "someone committed to a healthy lifestyle",
  "a disciplined and consistent person",
  "a role model for my family's health",
  "someone who takes care of their body",
];

/**
 * SlimCircle Identity Page (Authenticated Onboarding)
 * Collects the user's identity statement related to health and weight loss
 */
              ...
              {validationState === 'idle' && (
                ...
                >
                  ...
                  <p className="font-sans text-[14px] text-text-secondary leading-[1.4]">
                    Your identity defines WHO you are, not WHAT you want to achieve. For example: "I am someone committed to a healthy lifestyle" rather than "I want to lose weight".
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
