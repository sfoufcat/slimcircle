...
export async function sendWelcomeEmail({
  ...
  const subject = 'Welcome to SlimCircle: Your Transformation Starts Today 🎯';
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #2c2520; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <ul style="margin-bottom: 25px; padding-left: 20px;">
    <li style="margin-bottom: 8px;">📊 Daily tracking for meals, workouts, and weight</li>
    <li style="margin-bottom: 8px;">👥 Your accountability circle (no more doing this alone)</li>
    <li style="margin-bottom: 8px;">📅 Weekly check-ins to track your progress</li>
    <li style="margin-bottom: 8px;">🎯 A clear goal and timeline to keep you focused</li>
    <li style="margin-bottom: 8px;">💪 Support from others on the same journey</li>
  </ul>
  ...
  <p style="margin-bottom: 30px;">Welcome to the circle. ❤️</p>
...
📊 Daily tracking for meals, workouts, and weight
👥 Your accountability circle (no more doing this alone)
📅 Weekly check-ins to track your progress
🎯 A clear goal and timeline to keep you focused
...
export async function sendAbandonedEmail({
  ...
  const subject = 'Your SlimCircle plan is ready: complete your signup 🎯';
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #2c2520; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <ul style="margin-bottom: 25px; padding-left: 20px;">
    <li style="margin-bottom: 8px;">• Your weight-loss goal is already set</li>
    <li style="margin-bottom: 8px;">• Your accountability circle activates once you join</li>
    <li style="margin-bottom: 8px;">• Your daily tracking system is ready to go</li>
    <li style="margin-bottom: 8px;">• Your first weekly check-in begins the moment you're inside</li>
  </ul>
...
• Your weight-loss goal is already set
• Your accountability circle activates once you join
• Your daily tracking system is ready to go
• Your first weekly check-in begins the moment you're inside
